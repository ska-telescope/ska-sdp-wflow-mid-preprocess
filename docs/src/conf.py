...
project = 'SKA SDP Workflow pre-processing'
...
breathe_projects = { "ska-sdp-wflow-mid-preprocess": os.path.join("..", "doxygen", "xml")}
breathe_default_project = "ska-sdp-wflow-mid-preprocess"
